...
- Magical classes now begin with 1 study point and start with their class-appropriate beginner book (`[Beginners-Magik]` for mage classes, `[Beginners Handbook]` for priest classes).
